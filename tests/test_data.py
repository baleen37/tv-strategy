...
class TestCCXTClient:
    ...
    def test_ccxt_client_initialization(self):
    ...
    def test_ccxt_client_with_testnet(self):
    ...
    def test_download_btcusdt_data(self, mock_exchange):
    ...
    def test_download_ethusdt_data(self, mock_exchange):
    ...
    def test_invalid_symbol_error(self, mock_exchange):
    ...
    def test_api_rate_limit_handling(self, mock_exchange):
    ...
    def test_network_error_handling(self, mock_exchange):
...
class TestDataValidator:
    ...
    def test_validate_ohlcv_structure(self):
        ...
        assert validator.validate_ohlcv(valid_data) is True
    ...
    def test_validate_price_relationships(self):
        ...
        assert validator.validate_price_relationships(valid_data) is True
        ...
        assert validator.validate_price_relationships(invalid_data) is False
    ...
    def test_validate_missing_data(self):
        ...
        missing_count = validator.detect_missing_data(data_with_gap, timeframe="1d")
        assert missing_count == 1  # One missing day
...
class TestParquetStorage:
    ...
    def test_save_parquet_file(self, sample_data, tmp_path):
    ...
    def test_load_parquet_file(self, sample_data, tmp_path):
    ...
    def test_data_compression(self, sample_data, tmp_path):
...
class TestDataDownloader:
    ...
    def test_download_workflow(self, mock_client_class):
...
class TestCLIInterface:
    ...
    def test_download_command_btcusdt(self, mock_downloader_class):
    ...
    @patch("src.data.ccxt_client.DataDownloader")
    def test_download_command_ethusdt(self, mock_downloader_class):
    ...
    def test_download_command_invalid_args(self):
...
class TestErrorHandling:
    ...
    def test_ccxt_exchange_not_available(self):
    ...
    def test_insufficient_data_error(self, mock_exchange):
    ...
    def test_disk_space_error(self, sample_data, tmp_path):
